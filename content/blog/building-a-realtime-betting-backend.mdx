...
excerpt: >-
  Sockets are the easy part. The hard part is settlement that stays correct,
  queues that don't double-pay, and a matching engine that agrees with itself
  under load.
cover: >-
  /images/blog/building-a-realtime-betting-backend/1787773905813-realtime-betting-backend-hero.png
draft: false
---
